 ...
 * <p>
 * The code shows how to use <code>RandomGraph</code> and <code>WattsStrogatz</code>
 * generators and push result into the graph structure using <code>ImportController</code>.
 * <p>
 * In Gephi import and generate are not directly appened to the main graph structure
 * for consistency reasons. New data are pushed in a <code>Container</code> and then
 * appened to the graph structure with the help of a <code>Processor</code>.
 * <p>
